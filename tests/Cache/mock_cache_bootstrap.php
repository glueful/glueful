...
/**
 * Master mock bootstrap file for cache tests
 *
 * This file is loaded by PHPUnit before running tests and sets up
 * all necessary mocks to make cache tests run without Redis.
 *
 * It uses autoloading to intercept Redis class creation.
 */

// Create a safe version of the Redis class if it doesn't exist
if (!class_exists('Redis')) {
    // Our mock implementation of the Redis class
    class Redis // phpcs:ignore PSR1.Classes.ClassDeclaration.MissingNamespace
    {
...
/**
 * Create autoloader to handle cache-related factory classes
 */
spl_autoload_register(function ($class) {
    // Track what class is being loaded for debugging
    // echo "Loading class: $class\n";

    if ($class === 'Glueful\\Cache\\CacheFactory') {
        // Create a mock CacheFactory that doesn't use Redis
        require_once __DIR__ . '/mock_factory_classes.php';
        class_alias('Glueful\\Tests\\Mocks\\MockCacheFactory', $class);
        return true;
    }
