...
/**
 * ComplianceManager Routes
 *
 * These routes define the API endpoints for the ComplianceManager extension.
 */
...
Router::group('/{{SNAKE_CASE_NAME}}', function() {
    ...
    Router::get('/', function($request) {
        $extension = \Glueful\Helpers\ExtensionsManager::findExtension('ComplianceManager');
