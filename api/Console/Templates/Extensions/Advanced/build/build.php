...
/**
 * Advanced Extension Template Build Script
 *
 * This script builds the Advanced extension template into a .gluex package for distribution.
 */
...
$templateName = isset($argv[1]) ? $argv[1] : 'AdvancedExtension';
...
{
    echo "Advanced Extension Template Build Script\n";
    echo "Usage: php build.php [ExtensionName] [options]\n\n";
    echo "Arguments:\n";
    echo "  ExtensionName Name for the extension (default: AdvancedExtension)\n\n";
    echo "Options:\n";
    echo "  --help, -h    Show this help message\n";
    echo "  --clean, -c   Clean output directory before building\n\n";
    echo "This script builds the Advanced extension template into a .gluex package.\n";
    echo "Example: php build.php MyAdvancedExtension\n";
}
